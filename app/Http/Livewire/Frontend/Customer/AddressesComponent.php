...
class AddressesComponent extends Component
{
    ...
    public function store_address()
    {
        ...
        $this->resetForm();
        $this->showForm = false;
        $this->alert('success', __('Address created successfully'));
    }
    ...
    public function update_address()
    {
        ...
        $this->resetForm();
        $this->showForm = false;
        $this->alert('success', __('Address updated successfully'));
    }
    ...
    public function delete_address($id)
    {
        ...
        $this->alert('success', __('Address deleted successfully'));
    }
