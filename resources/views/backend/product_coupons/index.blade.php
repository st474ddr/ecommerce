        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('admin.product_coupons.create') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{ __('Add coupon') }}</span>
                </a>
            </div>
        </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="javascript:void(0);" onclick="if (confirm('是否確認要刪除?')) { document.getElementById('delete-product-coupon-{{ $coupon->id }}').submit(); } else { return false; }" class="btn btn-danger">
