...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit').__('Coupon') }} ({{ $productCoupon->code }})</h6>
            <div class="ml-auto">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ old('status', $productCoupon->status) == '1' ? 'selected' : null }}>{{ __('Active') }}</option>
                                <option value="0" {{ old('status', $productCoupon->status) == '0' ? 'selected' : null }}>{{ __('Inactive') }}</option>
                            </select>
