...
<div class="card shadow mb-4">
    <div class="card-header py-3 d-flex">
        <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit').__('category') }} {{ $productCategory->name }}</h6>
        <div class="ml-auto">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <select name="status" class="form-control">
                        <option value="1" {{ old('status', $productCategory->status) == 1 ? 'selected' : null }}>{{ __('Active') }}
                        </option>
            ...
            <div class="row pt-4">
                <div class="col-12">
                    ...
                    <div class="file-loading">
                        ...
                        <span class="form-text text-muted">{{ __('Image width should be') }} 500px x 500px</span>
