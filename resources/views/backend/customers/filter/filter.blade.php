<div class="card-body">
    ...
    <div class="row">
        ...
        <div class="col-2">
            <div class="form-group">
                <select name="sort_by" class="form-control">
                    ...
                    <option value="first_name" {{ old('sort_by', request()->input('sort_by')) == 'first_name' ? 'selected' : '' }}>{{ __('First Name') }}</option>
                    <option value="last_name" {{ old('sort_by', request()->input('sort_by')) == 'last_name' ? 'selected' : '' }}>{{ __('Last Name') }}</option>
        ...
        <div class="col-1">
            <div class="form-group">
                <button type="submit" name="submit" class="btn btn-secondary">{{ __('Search') }}</button>
            </div>
        </div>
    </div>
    </form>
