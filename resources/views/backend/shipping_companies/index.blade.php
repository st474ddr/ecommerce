...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Shipping Companies') }}</h6>
            <div class="ml-auto">
                <a href="{{ route('admin.shipping_companies.create') }}" class="btn btn-primary">
                    <span class="icon text-white-50">
                        <i class="fa fa-plus"></i>
                    </span>
                    <span class="text">{{ __('Add shipping company') }}</span>
                </a>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                @forelse($shipping_companies as $shipping_company)
                    <tr>
                        ...
                        <td>{{ __($shipping_company->status()) }}</td>
                        <td>
                            <div class="btn-group">
