...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Edit')." ".__('Shipping Company') }} ({{ $shipping_company->name }})</h6>
            <div class="ml-auto">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ old('status', $shipping_company->status) == '1' ? 'selected' : null }}>{{ __('Actiave') }}</option>
                                <option value="0" {{ old('status', $shipping_company->status) == '0' ? 'selected' : null }}>{{ __('Inactive') }}</option>
                            </select>
