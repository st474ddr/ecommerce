...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Create').__('Addresses') }}</h6>
            <div class="ml-auto">
        ...
        <div class="card-body">
            ...
            <form action="{{ route('admin.customer_addresses.store') }}" method="post">
                    ...
                    <div class="col-3">
                        <div class="form-group">
                            ...
                            <select name="default_address" class="form-control">
                                <option value="0" {{ old('default_address') == '0' ? 'selected' : null }}>{{ __('No') }}</option>
                                <option value="1" {{ old('default_address') == '1' ? 'selected' : null }}>{{ __('Yes') }}</option>
                            </select>
                ...
                <div class="form-group pt-4">
                    <button type="submit" name="submit" class="btn btn-primary">{{ __('Add an address') }}</button>
                </div>
            </form>
        </div>
    </div>
