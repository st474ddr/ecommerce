        ...
        <div class="card-header py-3 d-flex">
            ...
            <div class="ml-auto">
                <a href="{{ route('admin.cities.create') }}" class="btn btn-primary">
                    ...
                    <span class="text">{{ __('Add city') }}</span>
                </a>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                @forelse($cities as $city)
                    <tr>
                        ...
                        <td>{{ __($city->status()) }}</td>
                        <td>
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('admin.cities.edit', $city->id) }}" class="btn btn-primary">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a href="javascript:void(0);" onclick="if (confirm('是否確認要刪除該筆資料')) { document.getElementById('delete-cities-{{ $city->id }}').submit(); } else { return false; }" class="btn btn-danger">
