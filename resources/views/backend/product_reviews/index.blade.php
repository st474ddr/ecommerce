...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3 d-flex">
            <h6 class="m-0 font-weight-bold text-primary">{{ __('Product').__('Reviews') }}</h6>
            <div class="ml-auto">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group btn-group-sm">
                                ...
                                <a href="javascript:void(0);" onclick="if (confirm('是否確認要刪除該筆資料')) { document.getElementById('delete-product-review-{{ $review->id }}').submit(); } else { return false; }" class="btn btn-danger">
