<div wire:ignore>
    ...
    <section class="py-5">
        <header>
            <p class="small text-muted small text-uppercase mb-2">大家都在看...</p>
            <h2 class="text-uppercase mb-4">{{ __('Top trending products') }}</h2>
        </header>
        <div class="row">
                            ...
                            <ul class="mb-0 list-inline">
                                ...
                                <li class="list-inline-item m-0 p-0">
                                    <a wire:click.prevent="addToCart({{ $featuredProduct->id }})"
                                        class="btn btn-sm btn-dark">{{ __('Add to cart') }}</a>
                                </li>
