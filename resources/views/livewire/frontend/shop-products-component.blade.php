                ...
                <div class="col-lg-9 order-1 order-lg-2 mb-5 mb-lg-0">
                    <div class="row mb-3 align-items-center">
                        <div class="col-lg-6 mb-2 mb-lg-0">
                            <p class="text-small text-muted mb-0">{{ __('Showing') }}
                                {{ $products->firstItem() }}–{{ $products->lastItem() }}, {{ __('Total') }}: {{ $products->total() }}
                                {{ __('results') }}</p>
                        </div>
                        <div class="col-lg-6">
                            <ul class="list-inline d-flex align-items-center justify-content-lg-end mb-0">
                                ...
                                <li class="list-inline-item" wire:ignore>
                                    <select class="selectpicker ml-auto" wire:model="sortingBy" data-width="200"
                                        data-style="bs-select-form-control" data-title="{{ __('Default sorting') }}">
                                        <option value="default">{{ __('Default sorting') }}</option>
                                        <option value="popularity">{{ __('Popularity') }}</option>
                                        <option value="low-high">{{ __('Price: Low to High') }}</option>
                                        <option value="high-low">{{ __('Price: High to Low') }}</option>
                                    </select>
                                </li>
                            </ul>
                        </div>
